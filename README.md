...
- COMPARE CELL COMMUNICATION RESULTS:
  ...
  -- RUN ZZZ
  -- COMPARE RESULTS
  ALSO USE "COMPARE CELL COMMUNICATION RESULTS" INSTEAD OF "COMPARE RESULTS OF EACH TOOL". YOU HAVE SEVERAL TYPES OF RESULTS IN THE METHOD COMPARISON, SO IF OYU JUST SAY "RESULTS", IT IS NOT PRECISE. YOU ALSO DON'T HAVE TO SAY "OF EACH TOOL" -- YOU DIDN'T SAY IT FOR THE DATABASES, SO BE CONSISTENT.
