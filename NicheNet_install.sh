...
R -e 'devtools::install_github("saezlab/OmnipathR@v3.7.0"); devtools::install_github("saeyslab/nichenetr"); devtools::install_github("SoloveyMaria/community", upgrade = "always"); q()';
